...
//         //if we throw it will go to error function subscriber, else we can return default message to not to go to the erro function
//
//         //catchError(err=>of({title:'test',author:'test test'}))
//         //catchError(error=> {throw `Something Bad Happened - ${error.message}`})
//         catchError(err=> {return throwError(err.message)})
//     )
//     .subscribe(
//         finalval=>console.log(`VALUE:${finalval.title}`),
